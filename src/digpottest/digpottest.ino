...
void loop() {
  ...
  */
  if(Serial.available()){
    switch(Serial.read()){
      case '1': digitalPotWrite(wiper0writeAddr,0); break;
      case '2': digitalPotWrite(wiper0writeAddr,64); break;
      case '3': digitalPotWrite(wiper0writeAddr,128); break;
      case '4': digitalPotWrite(wiper0writeAddr,255); break;
    }
